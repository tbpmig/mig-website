...
urlpatterns = patterns('',
    ...
    url(r'^preferred_items_request/(?P<event_id>\d+)/$',views.preferred_items_request, name='preferred_items_request'),
    ...
    url(r'unsign_up_paired/(?P<shift_id>\d+)/$',views.unsign_up_paired, name='unsign_up_paired'),
    url(r'sign_up_paired/(?P<shift_id>\d+)/$',views.sign_up_paired, name='sign_up_paired'),
    url(r'unsign_up/(?P<shift_id>\d+)/$',views.unsign_up, name='unsign_up'),
    url(r'sign_up/(?P<shift_id>\d+)/$',views.sign_up, name='sign_up'),
    url(r'add_gcal_paired/(?P<shift_id>\d+)/$',views.add_shift_to_gcal_paired, name='add_shift_to_gcal_paired'),
    url(r'add_gcal/(?P<shift_id>\d+)/$',views.add_shift_to_gcal, name='add_shift_to_gcal'),
    url(r'remove_user_from_paired_shift/(?P<shift_id>\d+)-(?P<username>[a-z]{3,8})/$',views.manual_remove_user_from_paired_shift, name='manual_remove_user_from_paired_shift'),
    url(r'remove_user_from_shift/(?P<shift_id>\d+)-(?P<username>[a-z]{3,8})/$',views.manual_remove_user_from_shift, name='manual_remove_user_from_shift'),
    url(r'add_to_waitlist/(?P<shift_id>\d+)/$',views.add_to_waitlist, name='add_to_waitlist'),
    url(r'remove_from_waitlist/(?P<shift_id>\d+)/$',views.remove_from_waitlist, name='remove_from_waitlist'),
    url(r'meeting_sign_in/(?P<shift_id>\d+)/$',views.meeting_sign_in, name='meeting_sign_in'),

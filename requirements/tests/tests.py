"""
This contains the tests (unit and integration) for the requirements module.
...
def setUpModule():
    print 'setting up requirements test data...'
...
def tearDownModule():
    ...
    """
    print 'tearing down requirements module...'
...
class RequirementsModelsTestCase(TestCase):

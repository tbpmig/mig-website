...
urlpatterns = patterns(
    ...
    url(r'^twitter_oauth/$',
        'migweb.views.twitter_oauth',
        name='twitter_oauth'),
    url(r'^init_twitter/$',
        'migweb.views.initialize_twitter',
        name='initialize_twitter'),
    url(r'^slide_ajax/(?P<slide_id>\d+)/$',
        'migweb.views.get_slide_ajax',
        name='get_slide_ajax'),
    url(r'^photo_ajax/(?P<photo_id>\d+)/$',
        'migweb.views.get_eventphoto_ajax',
        name='get_eventphoto_ajax'),
    url(r'^article_photo_ajax/(?P<photo_id>\d+)/$',
        'migweb.views.get_article_photo_ajax',

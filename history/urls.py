...
urlpatterns = patterns('',
	...
	url(r'^view_project_reports/$',views.get_project_reports,name='get_project_reports'),
    ...
    url(r'^process_project_reports/$',views.process_project_report_compilation,name='process_project_report_compilation'),
	...
	url(r'^compile_reports/(?P<prh_id>\d+)/$',views.compile_project_reports,name='compile_project_reports'),
    url(r'^edit_stories/$',views.edit_articles,name='edit_articles'),

...
urlpatterns = patterns('',
	...
	url(r'^edit_outreach_event_types/$',views.manage_outreach_event_types, name='manage_outreach_event_types'),
	...
	url(r'^manage_outreach_events/(?P<url_stem>[a-z,_]+)/$',views.manage_outreach_events, name='manage_outreach_events'),

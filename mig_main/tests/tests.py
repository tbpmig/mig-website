"""
This contains the tests (unit and integration) for the mig_main module.
...
def setUpModule():
    print 'setting up mig_main test data...'
...
def tearDownModule():
    ...
    """
    print 'tearing down mig_main module...'
...
class MigMainModelsTestCase(TestCase):

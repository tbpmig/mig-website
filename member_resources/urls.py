...
urlpatterns = patterns('',
    ...
    url(r'^manage_interview_credit/$',views.manage_interview_credit,name='manage_interview_credit'),
    ...
    url(r'^tbplayground/$',views.member_playground,name='member_playground'),
